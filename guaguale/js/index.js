(function () {
     ...
     // canvas逻辑
        ...
        function buildResultContent(data) {
            ...
            Tpl='<div class="result-box">'+
                '<span>恭喜您,刮中了</span>'+
                '<p class="result-price">{0}元返利红包</p>'+
                '<a class="{1} btn-result" href="javascript:void(0);" data-spm="super_lbhongbao.h5.pty-again~type-cash~module-popup">{1}</a>'+
                '</div>'.format(money,btnClass, btnVal);

            $resultWrap.html("").append(Tpl);
        }
